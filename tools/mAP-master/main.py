...
parser.add_argument('--image_dir', default = 'images', type=str, help="images directory")
parser.add_argument('--ground_truth', default = 'ground-truth/', type=str, help="ground_truth directory")
parser.add_argument('--prediction', default = 'predicted/', type=str, help="predicted txt directory")
...
def __main(args):
  ...
  for txt_file in ground_truth_files_list:
    ...
    if not os.path.exists(prediction_path + file_id + ".txt"):
      error_msg = "Error. File not found: " + prediction_path + file_id + ".txt\n"
  ...
  predicted_files_list = glob.glob( prediction_path + '/*.txt')
  ...
  for class_index, class_name in enumerate(gt_classes):
    ...
    for txt_file in predicted_files_list:
      ...
      file_id = os.path.basename(os.path.normpath(file_id))
      if class_index == 0:
        if not os.path.exists(ground_truth_path + file_id + ".txt"):
          error_msg = "Error. File not found:"+ ground_truth_path +  file_id + ".txt\n"
          error_msg += "(You can avoid this error message by running extra/intersect-gt-and-pred.py)"
          error(error_msg)
