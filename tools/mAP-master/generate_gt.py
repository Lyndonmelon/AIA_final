...
parser.add_argument('--bbox_txt', default='C:\\Users\\shawp\\Desktop\\AI_Stuff\\AT073_49_Orig_Trash\\data\\Bing\\bbox_Bing_seq_41\\', type=str, help='Path to bbox_txt dir generated by OpenLabeling | Default: bbox_txt/')
parser.add_argument('--img_dir', default='C:\\Users\\shawp\\Desktop\\AI_Stuff\\AT073_49_Orig_Trash\\data\\Bing\\Bing_seq_41\\', type=str, help='Path to Images folder | Default: images/')
parser.add_argument('--class_list', default='class_list.txt', type=str, help='Path to class_list.txt file | Default: class_list.txt')
parser.add_argument('--save_dir_xml', default='C:\\Users\\shawp\\Desktop\\AI_Stuff\\AT073_49_Orig_Trash\\data\\Bing\\xml_Bing_seq_41\\', type=str, help='Where to save XML Files | Default: annotations_xml/')
parser.add_argument('--save_dir_txt', default='C:\\Users\\shawp\\Desktop\\AI_Stuff\\AT073_49_Orig_Trash\\data\\Bing\\xml_Bing_seq_41\\', type=str, help='Where to save XML Files | Default: annotations_xml/')

args = parser.parse_args()

bbox_txt = args.bbox_txt
imagefolder = args.img_dir
saveDir_xml = args.save_dir_xml
saveDir_txt = args.save_dir_txt
format = args.format

if not os.path.exists(saveDir_xml):
    os.makedirs(saveDir_xml)

if not os.path.exists(saveDir_txt):
    os.makedirs(saveDir_txt)
...
#     img_tail = imagename[-3:]
#     if img_tail.upper() != 'JPG':
#         continue
...
#     imgHeight, imgWidth, depth = img.shape
    ...
    write_txt(saveDir_txt, imagename, bounding_boxes)
    # write_xml(saveDir_xml, imagefolder, imagename, imgWidth, imgHeight, depth, bounding_boxes, pose="Unspecified")
